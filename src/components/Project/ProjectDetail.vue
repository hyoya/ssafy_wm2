  ...
  <v-flex xs3>
    <v-dialog v-model="popol" max-width="60vw" hide-overlay>
      ...
      <template v-slot:activator="{ on }">
        <v-btn flat class="white--text" v-on="on" style="height : 100%">
          <v-flex>
            <v-card style=" width:200px">
              ...
              <v-card-title primary-title style="width:100%">
                <div style="text-overflow:ellipsis">
                  <div class="black--text text-overflow:ellipsis">
                    <span style="text-overflow:ellipsis">{{projecttitle}}</span>
                  </div>
                  <span class="grey--text text-overflow:ellipsis">{{projectdescription}}</span>
                </div>
              </v-card-title>
            </v-card>
          </v-flex>
      ...
      <v-card>
        <v-toolbar>
          ...
          <v-toolbar-title class="font-weight-medium">
            ...
            <v-flex class="caption">{{ projectdescription }}</v-flex>
          </v-toolbar-title>
          <v-spacer />
